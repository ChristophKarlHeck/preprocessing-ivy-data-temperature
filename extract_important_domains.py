...
def extract_data(data_dir, prefix, before, after):
    ...
    for i, ax in enumerate(axes):
        for j, start_time in enumerate(distinct_increasing_starts):
            ...
            # Highlighting domain (30 min before and after)
            ax.axvspan(start_time - pd.Timedelta(minutes=30), start_time + pd.Timedelta(minutes=30), 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--before", type=int, required=True, help="Time in minutes befor increase starts.")
    parser.add_argument("--after", type=int, required=True, help="Time in minutes after increase starts.")
